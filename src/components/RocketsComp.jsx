...
const RocketsComp = () => {
    ...
    const handleSearch = (searchValue) => {
        const filteredElems = eventsDefault.filter(elem => {
            return elem.rocket_name.toLowerCase().includes(searchValue.toLowerCase())
        })
    ...
    return (
        ...
        <div className="container col-md-6 offset-md-3 rocket-box">
            <div className="search-box input-group">
                <input type="text" className="form-control" placeholder="Search rockets of SpaceX" value={search}
